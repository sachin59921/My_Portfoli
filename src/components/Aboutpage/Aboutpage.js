        ...
        <Row className="textbackground">
          <Col md={7}>
            ...
            <p className="aboutdetails">
              ...
              Software Quality Assurance (QA).<br> 🛠️ I recently completed a QA
              internship at SJ Innovation Pvt. Ltd., where I gained hands-on
              experience in:</br> Manual testing of web applications Designing and
              ...
              collaboration — and fueled my passion for delivering reliable and
              user-focused products. <br>💻 I also bring frontend skills in HTML5,
              CSS3, JavaScript, and React.js, which help me understand user
              interfaces from both a developer and a tester’s perspective —
              making my QA work more insightful and efficient.</br> <br>📸 Outside of
              tech, I enjoy photography and exploring new places, which enhance
              my attention to detail and creative thinking.</br> <br> 🚀 I’m currently
              ...
              contribute to high-quality software development.</br> <br>📬 Let’s connect!
